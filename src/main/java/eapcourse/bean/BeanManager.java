...
public class BeanManager
{
	...
	public void save()
	{
		System.out.println("Calling ServiceBean.put operation.");
	...
	public void clear(final SimpleProperty property)
	{
		System.out.println("Calling ServiceBean.clear operation.");
